...
export class SolicitacaoService {
  private baseUrl = 'http://localhost:8443/solicitacoes'; 
  ...
  switch (nomeCategoria?.toLowerCase()) {
    ...
    case 'impressora': return 3;
    case 'mouse': return 4;
    case 'teclado': return 5;
    default: return 0;
  }
}
...
// Listar categorias (com mock) fazer a integração
  ...
  mapStatus(idStatus?: number): string {
    switch (idStatus) {
      ...
      case 2: return 'ORÇADA';
      case 3: return 'APROVADA';
      case 4: return 'REJEITADA';
      case 5: return 'ARRUMADA';
      case 6: return 'PAGA';
      case 7: return 'FINALIZADA';
      case 8: return 'REDIRECIONADA';
