...
import { catchError, of, Subscription, take, finalize } from 'rxjs'; // Adicionado finalize
...
import { RelatorioService } from '../../services/relatorio.service'; // Importe seu serviço de relatório

export interface Solicitation {
  // ... (mantenha sua interface igual)
...
export class HomeFuncionario implements OnInit, OnDestroy {
  ...
  // --- Lógica do Modal de Relatórios
  
  initializeReportDates(): void {
    const now = new Date();
    // primeiro e último dia do mês atual tão em YYYY-MM-DD
