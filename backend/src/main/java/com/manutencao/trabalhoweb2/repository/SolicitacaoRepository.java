...
List<Object[]> findAllLastUpdate();
     ...
     * Agrupa por dia (CAST dataHora as LocalDate) baseando-se no histórico onde status virou 'PAGA'.
     */
    ...
    /**
     * RF020 - Receita por Categoria (Total acumulado)
     * Fazemos join manual com Categoria (c) usando o ID, pois não há mapeamento direto.
     * Filtramos pelo Histórico 'PAGA' para garantir que só somamos o que foi pago.
     */
